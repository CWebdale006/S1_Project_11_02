...
*/
// Declares a thisDate variable containing the Date object for the date. 
var thisDate = new Date();

// Declares the dateString variable containing the text of the thisDate variable using local conventions. 
var dateString = thisDate.toLocaleString();

// Declares the dateHTML variable containing the following text string. 
var dateHTML = "<h2>" + dateString + "</h2>";

// Creates the thisDay variable containing the day of the week from the thisDate variable. 
var thisDay = thisDate.getDay();

// Uses the thisDay variable as the parameter value in the getEvent() function. Stores the answer in a variable named eventHTML. 
var eventHTML = getEvent(thisDay);

// Inserts the value of the dateHTML plus the eventHTML variables before the end of the element contents using the insertAdjacentHTML() method. 
